...
export const Third = () =>{
    return (
        <div className="mt-20">
        <div className="bg-green-600 h-[27rem] w-[60rem] mt-32">
        ...
        <button className="border border-white rounded-full bg-black hover:bg-white text-white w-16 h-16 hover:text-black hover:border-black mt-[10rem] ml-[28rem] my-[3rem]">▯</button>

         <h1 className="text-green-600 px-[20rem] py-[-13rem] font-bold text-xl mt-[-5.5rem]" >WATCH</h1>
         <h1 className="text-green-600 px-[35.5rem] mt-[-2rem] font-bold text-xl " >VIDEO</h1>
